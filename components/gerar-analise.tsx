    ...
    try {
      ...
      const organogramaHtml = analise.anexos?.organograma_url ? `
        ...
        <div class="card" style="padding:1rem; text-align:center; overflow:hidden;">
            <img src="${analise.anexos.organograma_url}" alt="Organograma" style="max-width:100%; height:auto; object-fit:contain; max-height:400px; border-radius: 0.5rem;" />
        </div>
      ` : "";
      ...
      const fachadaHtml = analise.anexos?.fachada_url ? `
        ...
        <div class="card" style="padding:1rem; text-align:center; overflow:hidden;">
            <img src="${analise.anexos.fachada_url}" alt="Fachada" style="max-width:100%; height:auto; object-fit:contain; max-height:400px; border-radius: 0.5rem;" />
        </div>
      ` : "";
      ...
      <div class="container">
          ...
          <h2>Propostas e Condições Comerciais</h2>
