...
const montarHtmlDossie = (item: any) => {
  ...
  <div class="container">
      ...
      <div class="parecer-wrapper" style="margin-top: 3rem;">
          ...
          <div class="parecer-body"><span style="color: var(--blue-dark); font-weight: 800; font-size: 1.1rem; display:block; margin-bottom: 1rem;">RECOMENDAÇÃO TÉCNICA: ${analise.recomendacao_analista?.toUpperCase() || 'EM ANÁLISE'}</span>${analise.parecer_comite || analise.parecer_analista || 'Sem parecer conclusivo preenchido.'}</div>
    ...
    try {
      ...
      if (userStr) {
        ...
        if (cargoUser === "comercial" && user.nome) {
          ...
          queryEsteira = queryEsteira.eq("comercial", user.nome);
        }
      }
