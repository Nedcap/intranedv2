...
// 🔥 FIX 1: Agora entende tanto DD/MM/YYYY quanto MM/YYYY direto da planilha
...
export default function DashboardPage() {
  ...
  const carregarDashboardFiel = async () => {
    try {
      ...
      receitasRaw.forEach((r: any) => {
        ...
        // Fallback adicionado para caso Juros seja lançado com a coluna mês/ano em vez de data
  ...
  // 🔥 FIX 2: Desacoplado do Filtro de Cedentes. Agora obedece APENAS ao mês.
  ...
  analises.forEach(a => {
    ...
    if (dRec) {
      ...
      // Avalia independente de quem está marcado no "cedentesSel"
      if (bateMes) {
